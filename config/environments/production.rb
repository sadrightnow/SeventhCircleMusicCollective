...
Rails.application.configure do
  ...
  # Configure the mailer to use SMTP with Gmail for production (example setup).
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address:              "smtp.gmail.com",
    port:                 587,
    domain:               "seventhcircle.fly.dev",
  ...
  # config.active_job.queue_name_prefix = "seventhcircle_production"
